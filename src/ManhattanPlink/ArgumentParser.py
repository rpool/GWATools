...
def ParseArguments(Log=None):
    ...
    ArgumentParser.add_argument('-s',
                                '--plinkoutputfile',
                                dest='PlinkOutputFile',
                                help='FILENAME: Name of output file of the plink run (input)',
                                metavar='FILENAME')
    ...
    ArgumentParser.add_argument('-p',
                                '--plinkoutputpath',
                                dest='PlinkOutputPath',
                                help='PATH: Name of output file path of the plink run (input)',
                                metavar='PATH')
    ArgumentParser.add_argument('-e',
                                '--plinkoutputpreext',
                                dest='PlinkOutputPreExtStr',
                                help='STRING: Pre-extension string of the plink output files (input)',
                                metavar='STRING')
    ArgumentParser.add_argument('-P',
                                '--nphenotypes',
                                dest='NPhe',
